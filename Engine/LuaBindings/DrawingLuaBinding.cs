...
namespace in254.Engine.LuaBindings
{
    public sealed class DrawLuaBinding : LuaBindingBase
    {
        public override void Register(Script luaScript)
        {
            ...
            drawTable["AddRequest"] = (Action<DynValue, DynValue, DynValue, DynValue, DynValue, DynValue, DynValue, DynValue, DynValue, DynValue>)((
                textureIdDyn, positionDyn, rotationDyn, scaleDyn, colorDyn, layerDepthDyn, widthDyn, heightDyn, spriteOffXDyn, spriteOffYDyn) =>
            {
        ...
        private static void AddRequestInternal(string modId, DynValue textureIdDyn, DynValue positionDyn, DynValue rotationDyn,
            ...
            DynValue widthDyn, DynValue heightDyn, DynValue spriteOffXDyn, DynValue spriteOffYDyn)
        {
            ...
            // Call engine
            DrawManager.Instance.AddRequest(texture, position, rotation, scale, color, layerDepth, width, height, spriteOffsetX, spriteOffsetY);
        }
    }
}
