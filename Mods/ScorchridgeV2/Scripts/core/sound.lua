...
function SFX.Step()       Sound.Play("step", 0.2) end
function SFX.Interact()   Sound.Play("interact", 0.5) end
...
function SFX.LoadGameplaySounds()
    ...
    print("[ScorchridgeV2] Gameplay sounds loaded.")
end
...
function SFX.LoadMenuSounds()
    Sound.Load("click", "click.wav")
    Sound.Load("hover", "hover.wav")
    print("[ScorchridgeV2] Menu sounds loaded.")
end
